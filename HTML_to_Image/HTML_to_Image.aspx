<%@ Page Title="Convert HTML to Raster Image" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="HTML_to_Image.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_Image.HTML_to_Image" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            Convert a HTML page from an URL or a HTML String to a raster image using the basic
                                                            options of converter. The Full Description and a Code Sample can be accessed from
                                                            the top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 110px">
                                                                                    <asp:DropDownList ID="imageFormatComboBox" runat="server" AutoPostBack="True" 
                                                                                        onselectedindexchanged="imageFormatComboBox_SelectedIndexChanged">
                                                                                ...
                                                                                <td>
                                                                                    <asp:CheckBox ID="transparentBackgroundCheckBox" runat="server" 
                                                                                        Text="Transparent Background" Checked="True" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="convertToImageButton" runat="server" 
                                                                Text="Convert HTML to Image" OnClick="convertToImageButton_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
