    ...
    public partial class Text_Elements : System.Web.UI.Page
    {
        protected void createPdfButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                PdfFont localTrueTypeFont = pdfDocument.AddFont(Server.MapPath("~/DemoAppFiles/Input/Fonts/TrueType.ttf"));
                ...
                PdfFont localOpenTypeTrueTypeFont = pdfDocument.AddFont(Server.MapPath("~/DemoAppFiles/Input/Fonts/OpenTypeTrueType.otf"));
                ...
                PdfFont localOpenTypePostScriptFont = pdfDocument.AddFont(Server.MapPath("~/DemoAppFiles/Input/Fonts/OpenTypePostScript.otf"));
