<%@ Page Title="Add Graphic Elements to a PDF Document" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Graphic_Elements.aspx.cs" Inherits="EvoHtmlToPdfDemo.PDF_Creator.Graphic_Elements" %>
                ...
                <table style="width: 100%; height: 100%">
                    <tr>
                        <td style="font-size: 14px; font-weight: bold; height: 20px; padding-bottom: 15px;
                            padding-top: 5px">
                            Add Graphic Elements to a PDF Document
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to add various types of graphic elements to
                                                            a PDF document. You can save the created PDF document to a file, a stream or in
                                                            a memory buffer. The Full Description and a Code Sample can be accessed from the
                                                            top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
