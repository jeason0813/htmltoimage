<%@ Page Title="PDF Creator - Set PDF Viewer Preferences for the Generated PDF Document"
    Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Set_Viewer_Preferences.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.PDF_Creator.PDF_Viewer_Preferences.Set_Viewer_Preferences" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to set various PDF viewer preferences to be
                                                            used when the generated PDF document is displayed in a PDF viewer. The Full Description
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 110px">
                                                                                    <asp:DropDownList ID="pageModeComboBox" runat="server">
                                                                                        <asp:ListItem>Default</asp:ListItem>
                                                                                        <asp:ListItem>Display Outlines</asp:ListItem>
                                                                                        <asp:ListItem>Display Thumbnails</asp:ListItem>
                                                                                        <asp:ListItem>Display Full Screen</asp:ListItem>
                                                                                        <asp:ListItem>Display Optional Content Group</asp:ListItem>
                                                                                        <asp:ListItem>Display Attachments</asp:ListItem>
                                                                                    </asp:DropDownList>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    ...
                                                                    <td>
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:DropDownList ID="pageLayoutComboBox" runat="server">
                                                                                        <asp:ListItem>Single Page</asp:ListItem>
                                                                                        <asp:ListItem>One Column</asp:ListItem>
                                                                                        <asp:ListItem>Two Column Left</asp:ListItem>
                                                                                        <asp:ListItem>Two Column Right</asp:ListItem>
                                                                                    </asp:DropDownList>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:CheckBox ID="hideMenuBarCheckBox" runat="server" Text="Hide Menu Bar" />
                                                                                </td>
                                                                                <td style="width: 10px">
                                                                                </td>
                                                                                <td>
                                                                                    <asp:CheckBox ID="hideToolbarCheckBox" runat="server" Text="Hide Toolbar" />
                                                                                </td>
                                                                                <td style="width: 10px">
                                                                                </td>
                                                                                <td>
                                                                                    <asp:CheckBox ID="hideWindowUICheckBox" runat="server" Text="Hide Window UI" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:CheckBox ID="displayDocTitleCheckBox" runat="server" Text="Display Document Title" />
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
