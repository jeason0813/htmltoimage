<%@ Page Title="PDF Creator - Set Initial Zoom Level of the Generated PDF Document"
    Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Set_Initial_Zoom_Level.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.PDF_Creator.PDF_Viewer_Preferences.Set_Initial_Zoom_Level" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to set the initial zoom level and the fit mode
