<%@ Page Title="Add URI Links in a PDF Document" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="URI_Links.aspx.cs" Inherits="EvoHtmlToPdfDemo.PDF_Creator.URI_Links" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to transform any region of a PDF page into
                                                            a link to a web page. You can save the created PDF document to a file, a stream
