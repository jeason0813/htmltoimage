<%@ Page Title="PDF Creator - Change Header and Footer per Page" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Header_Footer_Change.aspx.cs" Inherits="EvoHtmlToPdfDemo.PDF_Creator.Headers_and_Footers.Header_Footer_Change" %>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            shows how to change the header and footer only in the first page of the generated
                                                            PDF, leaving the default header and footer in the other pages. The Full Description
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox ID="changeHeaderAndFooterCheckBox" runat="server" Text="Change the Header and Footer in First Page"
