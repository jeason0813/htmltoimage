<%@ Page Title="Define in HTML the Table of Contents Items" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Define_in_HTML_Table_of_Contents_Items.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Table_of_Contents.Define_in_HTML_Table_of_Contents_Items" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to define a table of contents directly in HTML
                                                            using a set of special attributes. You can set the attribute 'data-toc-item' on
                                                            a HTML element to enable the creation a table of contents entry for that element
                                                            in PDF. Additionally you can specify the item level in table of contents with 'data-toc-level'
                                                            attribute and the bookmark title with 'data-toc-title' attribute. The Full Description
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:RadioButton ID="convertHtmlRadioButton" GroupName="HtmlPageSource" runat="server"
                                                                            Text="Convert HTML with Table of Contents" OnCheckedChanged="convertHtmlRadioButton_CheckedChanged"
