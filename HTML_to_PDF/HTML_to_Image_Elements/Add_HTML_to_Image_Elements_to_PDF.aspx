<%@ Page Title="Add HTML to Image Elements to a PDF Document" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Add_HTML_to_Image_Elements_to_PDF.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.HTML_to_Image_Elements.Add_HTML_to_Image_Elements_to_PDF" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to convert a HTML page to an image in a PDF
                                                            document by adding a HTML to Image Element at a given location in the PDF document.
                                                            You can add multiple HTML to Image Elements in the same PDF document. The Full Description
