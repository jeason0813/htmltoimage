<%@ Page Title="Select in HTML the Elements to Bookmark" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Select_in_HTML_Elements_to_Bookmark.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Bookmarks.Select_in_HTML_Elements_to_Bookmark" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to define a hierarchy of bookmarks directly
                                                            in HTML using a set of special attributes. You can set the attribute 'data-bookmark-enabled'
                                                            on a HTML element to enable the creation a bookmark for that element in PDF. Additionally
                                                            you can specify the bookmark level in hierarchy with 'data-bookmark-level' attribute
                                                            and the bookmark title with 'data-bookmark-text' attribute. The Full Description
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:RadioButton ID="convertHtmlRadioButton" GroupName="HtmlPageSource" runat="server"
                                                                            Text="Convert HTML with Bookmark Attributes" OnCheckedChanged="convertHtmlRadioButton_CheckedChanged"
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td style="font-weight: bold">
                                                                            HTML String with Bookmark Attributes
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
