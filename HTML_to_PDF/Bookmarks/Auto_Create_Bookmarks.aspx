<%@ Page Title="Auto Create Hierarchical Bookmarks" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Auto_Create_Bookmarks.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Bookmarks.Auto_Create_Bookmarks" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter can be configured to automatically create a hierarchy
                                                            of bookmarks in PDF document based on H1 to H6 head tags found in HTML document
                                                            by simply turning on a flag. The Full Description and a Code Sample can be accessed
                                                            from the top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox ID="autoBookmarksCheckBox" runat="server" Text="Create a Hierarchy of Bookmarks from H1 to H6 Tags"
