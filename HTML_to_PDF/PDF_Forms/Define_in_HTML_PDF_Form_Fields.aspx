<%@ Page Title="Define in HTML the PDF Form Fields" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Define_in_HTML_PDF_Form_Fields.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.PDF_Forms.Define_in_HTML_PDF_Form_Fields" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            You can select in HTML the fields you want to be converted to PDF form fields using
                                                            the 'data-pdf-form-field' special attribute. The other HTML fields which were not
                                                            explicitly selected will not be converted to PDF form fields. The Full Description
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:Panel ID="htmlStringPanel" runat="server" Visible="true">
                                                                <table>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:TextBox ID="htmlFormTextBox" runat="server" TextMode="MultiLine" Height="450px"
