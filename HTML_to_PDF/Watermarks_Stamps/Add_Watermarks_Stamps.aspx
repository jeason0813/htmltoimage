<%@ Page Title="Add Watermarks and Stamps to Generated PDF Document" Language="C#"
    MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Add_Watermarks_Stamps.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Watermarks_Stamps.Add_Watermarks_Stamps" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to add watermarks and stamps to generated PDF
                                                            document. You can add any PDF element in a watermark or a stamp repetead in each
                                                            PDF page, including HTML. The Full Description and a Code Sample can be accessed
                                                            from the top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
