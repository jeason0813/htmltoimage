<%@ Page Title="Convert HTML with SVG to PDF" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="SVG_to_PDF.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.HTML5_Features.SVG_to_PDF" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter offers full support for SVG. In this demo you can convert
                                                            a HTML page containing inline SVG to PDF. The Full Description and a Code Sample
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td style="padding-bottom: 5px; font-weight: bold" colspan="3">
                                                                        HTML Page with SVG to Convert to PDF
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="urlTextBox" runat="server" Width="435px">http://www.evopdf.com/DemoAppFiles/HTML_Files/SVG_Examples.html</asp:TextBox>
                                                                    </td>
                                                                    <td style="width: 5px">
                                                                    </td>
                                                                    <td>
