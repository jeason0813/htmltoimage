<%@ Page Title="Convert URI Links from HTML to PDF" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Convert_URI_Links_to_PDF.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.URI_Links.Convert_URI_Links_to_PDF" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter automatically converts all the URI links from HTML to
                                                            URI links in PDF. You can disable this behavior completely or you can selectively
                                                            disable the conversion of certain HTML links setting the 'data-link-enabled' attribute
                                                            value to false. The Full Description and a Code Sample can be accessed from the
                                                            top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox ID="enableUriLinksCheckBox" runat="server" Text="Enable the URI Links in PDF"
                                                                Checked="true" />
                                                        </td>
                                                    </tr>
                                                    <tr>
