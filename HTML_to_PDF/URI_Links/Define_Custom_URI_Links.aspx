<%@ Page Title="Define Custom URI Links in HTML" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Define_Custom_URI_Links.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.URI_Links.Define_Custom_URI_Links" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to transform any HTML element to an URI link
                                                            in PDF by setting the 'data-link-enabled' and 'data-link_href' attributes on HTML
                                                            element. With 'data-link-enabled' attribute you can also disable the automatic conversion
                                                            of a HTML URI link to a PDF link when you set this attribute to false. The Full
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:RadioButton ID="convertHtmlRadioButton" GroupName="HtmlPageSource" runat="server"
                                                                            Text="Convert HTML with Custom Link Attributes" OnCheckedChanged="convertHtmlRadioButton_CheckedChanged"
