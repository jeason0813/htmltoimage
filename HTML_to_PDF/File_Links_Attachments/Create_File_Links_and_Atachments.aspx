<%@ Page Title="Add File Links and Attachments to Generated PDF Document" Language="C#"
    MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Create_File_Links_and_Atachments.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.File_Links_Attachments.Create_File_Links_and_Atachments" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you create relative or absolute file links in PDF,
                                                            to create file attachments from files or from streams. Optionally you can also add
                                                            icons to mark the attachments in PDF document. In this demo some of the HTML elements
                                                            from converted HTML document are marked to become links to files or icons for attachments
                                                            in the generated PDF document. The Full Description and a Code Sample can be accessed
                                                            from the top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="htmlStringTextBox" runat="server" TextMode="MultiLine" Height="350px"
