<%@ Page Title="Avoid Page Breaks Inside HTML Elements Using CSS" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Page_Breaks.Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            You can avoid the page breaks inside a HTML element in the generated PDF document
                                                            by setting the 'page-break-inside : avoid' style for that element in HTML. The Full
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td style="padding-bottom: 5px; font-weight: bold" colspan="3">
                                                                            HTML Page With Page-Break-Inside : Avoid Styles
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td style="font-weight: bold">
                                                                            HTML String With Page-Break-Inside : Avoid Styles
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
