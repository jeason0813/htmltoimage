<%@ Page Title="Insert Page Breaks Before and After HTML Elements in PDF Using CSS"
    Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Insert_Page_Breaks_Before_After_Using_CSS.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Page_Breaks.Insert_Page_Breaks_Before_After_Using_CSS" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            You can insert page breaks before and after a HTML element in the generated PDF
                                                            document by setting the 'page-break-before : always' and 'page-break-after : always'
                                                            styles for that element in HTML. The Full Description and a Code Sample can be accessed
                                                            from the top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
