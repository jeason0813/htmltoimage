...
{
    public partial class Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS : System.Web.UI.Page
    {
        protected void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("Content-Disposition", String.Format("attachment; filename=Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS.pdf; size={0}", outPdfBuffer.Length.ToString()));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                htmlStringTextBox.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/HTML_Files/Page_Breaks_Inside_Avoid_Using_CSS.html"));
                baseUrlTextBox.Text = rootUrl + "DemoAppFiles/Input/HTML_Files/";

                urlTextBox.Text = rootUrl + "DemoAppFiles/Input/HTML_Files/Page_Breaks_Inside_Avoid_Using_CSS.html";

                sampleCodeLiteral.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Code_Samples/CSharp/AspNet/HTML_to_PDF/Page_Breaks/Avoid_Page_Breaks_in_CSS.html"));
                descriptionLiteral.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Descriptions/AspNet/HTML_to_PDF/Page_Breaks/Avoid_Page_Breaks_in_CSS.html"));

                Master.CollapseAll();
                Master.ExpandNode("HTML_to_PDF");
                Master.ExpandNode("Page_Breaks_Control");
                Master.SelectNode("Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS");
            }
        }
