<%@ Page Title="Convert the Current HTML Page to PDF" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Convert_Current_Page.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Convert_Current_Page" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            In this demo you can convert the current HTML page to PDF. The values you fill in
                                                            HTML form will be captured in the generated PDF document. The Full Description and
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td style="font-weight: bold" colspan="2">
                                                                        Fill the HTML Form Values to Capture in PDF
                                                                    </td>
                                                                </tr>
                                                                <tr>
...
Line 2</asp:TextBox>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="convertToPdfButton" runat="server" Text="Convert This HTML Page to PDF"
