<%@ Page Title="Add Elements in PDF Pages Background" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Add_Elements_in_Background.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.PDF_Pages_Background.Add_Elements_in_Background" %>
                ...
                <table style="width: 100%; height: 100%">
                    <tr>
                        <td style="font-size: 14px; font-weight: bold; height: 20px; padding-bottom: 15px;
                            padding-top: 5px">
                            Add Elements in PDF Pages Background
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you add elements in PDF pages background in BeforeRenderPdfPage
                                                            event handler. In this demo an image is added in the background of each PDF page.
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox ID="addBackgroundImageCheckBox" runat="server" Text="Add Background Image"
