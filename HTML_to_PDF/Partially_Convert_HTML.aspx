<%@ Page Title="Partially Convert a HTML Page to PDF" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Partially_Convert_HTML.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Partially_Convert_HTML" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            Sometimes you might need to convert just a part of the HTML page containing a table
                                                            or a chart. EVO HTML to PDF Converter allows you to select the HTML element from
                                                            page to be converted to PDF. In the example below only the HTML element with 'banner-panel-container'
                                                            ID s converted to PDF. The Full Description and a Code Sample can be accessed from
                                                            the top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:RadioButton ID="convertElementRadioButton" GroupName="ConvertElement" runat="server"
                                                                            Text="Convert Only the HTML Element" Checked="True" Font-Bold="False" />
                                                                    </td>
                                                                    <td style="width: 50px">
                                                                    </td>
                                                                    <td>
                                                                        <asp:RadioButton ID="convertEntirePageRadioButton" GroupName="ConvertElement" runat="server"
                                                                            Text="Convert the Entire HTML Page" Font-Bold="False" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td style="padding-bottom: 5px; font-weight: bold">
                                                                        HTML Element to Convert CSS Selector
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="htmlElementSelectorTextBox" runat="server" Text="#banner-panel-container"
