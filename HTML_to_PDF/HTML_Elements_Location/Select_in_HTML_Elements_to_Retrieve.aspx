<%@ Page Title="Select in HTML the Elements for Which to Retrieve Information" Language="C#"
    MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Select_in_HTML_Elements_to_Retrieve.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Elements_Location.Select_in_HTML_Elements_to_Retrieve" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to retrieve detailed information about any
                                                            element of the HTML page. You can get the element tag name, CSS class name, ID,
                                                            HTML code of the element and attributes. You can select the elements for which to
                                                            retrieve the information by adding the 'data-mapping-enabled' attribute to element
                                                            directly in HTML page. Additionally you can set a unique ID for an element with
                                                            'data-mapping-id' to help you find the element in the collection of retrieved elements.
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:RadioButton ID="convertHtmlRadioButton" GroupName="HtmlPageSource" runat="server"
                                                                            Text="Convert HTML with Mapping Attributes" OnCheckedChanged="convertHtmlRadioButton_CheckedChanged"
