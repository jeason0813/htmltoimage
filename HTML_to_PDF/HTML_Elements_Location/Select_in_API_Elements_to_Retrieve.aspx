<%@ Page Title="Select in API the HTML Elements for which to Retrieve Location" Language="C#"
    MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Select_in_API_Elements_to_Retrieve.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Elements_Location.Select_in_API_Elements_to_Retrieve" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter API allows you to select the HTML elements for which to
                                                            retrieve the location in PDF and other useful information from HTML document like
                                                            tag name, class, ID or HTML code. In this demo the selected HTML elements will be
                                                            highlighted in PDF with colored rectangles. The Full Description and a Code Sample
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td style="padding-bottom: 5px; font-weight: bold">
                                                                        HTML Elements to Highlight CSS Selector
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="htmlElementsSelectorTextBox" runat="server" Text="H1, H2, H3, H4, H5, H6"
