<%@ Page Title="Select in HTML the Elements to Hide in Generated PDF" Language="C#"
    MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Select_in_HTML_Elements_to_Hide.aspx.cs"
    Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Elements_Visibility.Select_in_HTML_Elements_to_Hide" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you select directly in HTML the elements to exclude
                                                            from rendering to PDF by setting the 'data-exclude' attribute on HTML elements you
                                                            want to exclude. The converter does not reflow the HTML content when you exclude
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:RadioButton ID="convertHtmlRadioButton" GroupName="HtmlPageSource" runat="server"
                                                                            Text="Convert HTML with Exclude Attributes" OnCheckedChanged="convertHtmlRadioButton_CheckedChanged"
