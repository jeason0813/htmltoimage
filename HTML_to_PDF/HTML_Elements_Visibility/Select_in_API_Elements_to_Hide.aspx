<%@ Page Title="Select in API the HTML Elements to Hide" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Select_in_API_Elements_to_Hide.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Elements_Visibility.Select_in_API_Elements_to_Hide" %>
                ...
                <table style="width: 100%; height: 100%">
                    <tr>
                        <td style="font-size: 14px; font-weight: bold; height: 20px; padding-bottom: 15px;
                            padding-top: 5px">
                            Select in API the HTML Elements to Hide
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter API allows you select the HTML elements to exclude from
                                                            rendering to PDF. The converter does not reflow the HTML content when you exclude
                                                            an element from rendering and the place where the element would be normally rendered
                                                            remains blank. If you want to reflow the HTML content when the HTML element is hidden,
                                                            you have to set 'display:none' style for HTML element, eventually creating two separate
                                                            stylesheets for screen and for print. The Full Description and a Code Sample can
                                                            be accessed from the top tabs.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="urlTextBox" runat="server" Text="http://www.nytimes.com" Width="500px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td style="padding-bottom: 5px; font-weight: bold">
                                                                        HTML Elements to Hide CSS Selector
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="htmlElementsSelectorTextBox" runat="server" Text="IMG" Width="500px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox ID="hideSelectedElementsCheckBox" runat="server" Text="Hide Selected Elements"
                                                                Font-Bold="False" Checked="True" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height: 20px">
