<%@ Page Title="Embed Fonts in Generated PDF Document" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Embed_Fonts_in_PDF.aspx.cs" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Fonts_Embedding.Embed_Fonts_in_PDF" %>
                ...
                <table style="width: 100%; height: 100%">
                    <tr>
                        <td style="font-size: 14px; font-weight: bold; height: 20px; padding-bottom: 15px;
                            padding-top: 5px">
                            Embed Fonts in Generated PDF Document
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter can embed the fonts in the generated PDF document to ensure
                                                            the PDF document is using the same fonts on any computer where the document is displayed.
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBox ID="embedFontsCheckBox" runat="server" Text="Embed Fonts" Font-Bold="False"
                                                                Checked="True" />
                                                        </td>
                                                    </tr>
                                                    <tr>
