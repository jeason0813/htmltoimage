<%@ Page Title="Stamp PDF Documents" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Stamp_PDF.aspx.cs" Inherits="EvoHtmlToPdfDemo.PDF_Editor.Stamp_PDF" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to add watermarks and stamps to a PDF document.
                                                            The resulted PDF document can be saved to a file, stream or memory buffer. The Full
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:HyperLink ID="pdfFileToStampHyperLink" runat="server" Target="_blank">View the PDF Document to Stamp</asp:HyperLink>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                                    ...
                                                                    <td>
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="stampWidthTextBox" runat="server" Width="40px">400</asp:TextBox>
                                                                                </td>
                                                                                <td style="width: 5px">
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="stampHeightTextBox" runat="server" Width="40px">400</asp:TextBox>
                                                                                </td>
                                                                                <td style="width: 5px">
                                                                                </td>
                                                                                <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="stampPdfButton" runat="server" Text="Stamp PDF" 
                                                                OnClick="stampPdfButton_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
