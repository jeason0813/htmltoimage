<%@ Page Title="Split PDF Documents" Language="C#" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Split_PDF.aspx.cs" Inherits="EvoHtmlToPdfDemo.PDF_Editor.Split_PDF" %>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            EVO HTML to PDF Converter allows you to split a PDF document into a set of smaller
                                                            PDF documents. The resulted PDF documents can be saved to files, streams or memory
                                                            buffers. In this demo the first PDF document resulted after split is sent to browser.
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:HyperLink ID="pdfFileToSplitHyperLink" runat="server" Target="_blank">View the PDF Document to Split</asp:HyperLink>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="splitPdfButton" runat="server" Text="Split PDF" OnClick="splitPdfButton_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
